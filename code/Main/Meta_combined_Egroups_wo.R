...
data <- read_csv("/home/marcelo/Sync/BrainLat/2024/Meta-eeg/data/tidy/combined_groups_data.csv")
save_path <- "/home/marcelo/Sync/BrainLat/2024/Meta-eeg/Results/final/wo/"
colnames(data)
...
#### Find outliers
find.outliers(rem.m) 
rem_outliers <- c("Montplaisir_1995", "Liguori_2017", "Liguori_2020", "Liguori_2014", "Rauchs_2008", "Boini_2022" )
find.outliers(n1.m) 
n1_outliers <- c("Liu_2020", "De Gennaro_2017", "Liguori_2020", "Azami_2023", "Liguori_2014", "Boini_2022")
find.outliers(n2.m)
n2_outliers <- c("Bonakis_2014", "Liu_2020", "Boini_2022")
find.outliers(n3.m) 
n3_outliers <- c("Liu_2020", "Maestri_2015", "Boini_2022")
find.outliers(se_p.m)
se_p_outliers <- c("De Gennaro_2017", "Liguori_2020", "Liguori_2019", "Boini_2022")
find.outliers(sl_m.m)
sl_m_outliers <- c("Boini_2022")
find.outliers(tst_m.m)
tst_m_outliers <- c("Maestri_2015", "Gorgoni_2016", "Liu_2020", "De Gennaro_2017", "Liguori_2020")
...
getwd()
setwd("/home/marcelo/Sync/BrainLat/2024/Meta-eeg/Results/final/wo")
####  Save results
### All predictors 
...
for (i in 1:length(names)){
    ...
    pdf(file=names[i], width = 9, height = 8, fonts =font, bg='white', title='A. Cognition')
