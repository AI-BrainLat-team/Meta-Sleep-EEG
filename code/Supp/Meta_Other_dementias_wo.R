...
data <- read_csv("/home/marcelo/Sync/BrainLat/2024/Meta-eeg/data/tidy/other_dem.csv")
save_path <- "/home/marcelo/Sync/BrainLat/2024/Meta-eeg/Results/Other_dementias/wo"
colnames(data)
...
setwd("/home/marcelo/Sync/BrainLat/2024/Meta-eeg/Results/Other_dementias/wo")
...
#Subgroup
# n1_sg <- update.meta(n1.m, subgroup = country, tau.common = FALSE)
# n2_sg <- update.meta(n2.m, subgroup = country, tau.common = FALSE)
# n3_sg <- update.meta(n3.m, subgroup = country, tau.common = FALSE)
# rem_sg <- update.meta(rem.m, subgroup = country, tau.common = FALSE)
...
### Forest plots
# names <- c("REM_p_Forest.png", "N1_p_Forest.png", "N2_p_Forest.png","se_p_Forest.png", "tst_m_Forest.png")
